...
export class WhitelistManager {
    ...
    bindEvents() {
        ...
        const swipeContainer = document.getElementById('whitelistTab');
        if (swipeContainer) {
            swipeContainer.style.minHeight = 'calc(100dvh - 120px)';
                ...
                container.innerHTML = `
                    <div class="empty-state">
                        <div>
                            ...
                            <div style="font-family: 'JetBrains Mono', monospace; font-size: 0.9em; color: var(--text-2);">Scanning Modules...</div>
                        </div>
                    </div>`;
            }
        }
    ...
    updateUI() {
        ...
        const cWhite = document.getElementById('count-whitelist');
